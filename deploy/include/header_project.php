		...
		<ul>
			<?php
				...
				if(isset($_SESSION['login'])){
					if (($_SESSION['job'])=="1") {
						echo '<li class="actif"><a href="project.php">Current project</a></li>';
						echo '<li><a href="new_project.php">Invitation</a></li>';
					}else if (($_SESSION['job'])=="2"){
						echo '<li class="actif"><a href="project.php">My projects</a></li>';
						echo '<li ><a href="new_project.php">Create project</a></li>';
